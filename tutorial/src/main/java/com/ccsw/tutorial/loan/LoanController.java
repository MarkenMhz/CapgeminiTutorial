...
public class LoanController {
    ...
    public Page<LoanDto> findPage(@RequestBody LoanSearchDto dto, @RequestParam(name = "clientName", required = false) String clientName, @RequestParam(name = "gameTitle", required = false) String gameTitle,
            @RequestParam(name = "date", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date date) {

        Page<Loan> page = this.loanService.findPage(dto, clientName, gameTitle, date);
